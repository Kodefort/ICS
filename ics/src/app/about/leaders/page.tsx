...
export default function LeadersPage() {
    const sections = [
        { id: 'board', title: 'Board of Trustees' },
        { id: 'president', title: 'Message from the President' },
        { id: 'director', title: 'Message from the Director' },
        { id: 'top', title: 'Top Leadership' },
        { id: 'academic', title: 'Academic Leaders' },
    ];

    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <h1 className="text-4xl font-bold text-[#0B2C5D] mb-8">Impact & Leaders</h1>
