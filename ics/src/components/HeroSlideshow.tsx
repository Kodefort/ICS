                    ...
                    <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
                      <div className="max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl">
                        ...
                        <div className="mt-3 sm:mt-4 md:mt-6">
                          <Link href="/admissions/apply" className="inline-block bg-[#0B2C5D] text-white px-4 py-2 sm:px-5 sm:py-2.5 md:px-6 md:py-3 lg:px-8 lg:py-4 rounded-md sm:rounded-lg text-xs sm:text-sm md:text-base lg:text-lg font-bold font-mono hover:bg-[#0a2347] transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl">
                            Apply Now
                          </Link>
                        </div>
                      </div>
