        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <h3 className="text-lg font-bold font-sans">Infinite Code School</h3>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold font-sans border-b-2 border-blue-400 pb-2 inline-block">Quick Links</h3>
          ...
          {/* Column 3: Programs */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold font-sans border-b-2 border-blue-400 pb-2 inline-block">Our Programs</h3>
            <ul className="space-y-3">
              <li>
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold font-sans border-b-2 border-blue-400 pb-2 inline-block">Get In Touch</h3>
